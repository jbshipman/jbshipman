...
Single source of truth for every fact. Decisions encoded where they're knowable. Conventions documented, then enforced by configuration, then automated. If a process needs a monthly debate, the process is missing a paragraph.
